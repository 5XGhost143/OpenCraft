...
public:
    ...
    void build(const World& world) {
        ...
        for (auto& [pos, id] : all) {
            ...
            {
                float r=col[0]*shade, g=col[1]*shade, b=col[2]*shade;
                // CCW winding: A B C  /  A C D
